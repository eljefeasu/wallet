...
class HistoriesControllerTest < ActionController::TestCase
  ...
  test "should create history" do
    assert_difference('History.count') do
      post :create, history: { amount: @history.amount, boolean: @history.boolean, description: @history.description }
    end
  ...
  test "should update history" do
    patch :update, id: @history, history: { amount: @history.amount, boolean: @history.boolean, description: @history.description }
    assert_redirected_to history_path(assigns(:history))
  end
